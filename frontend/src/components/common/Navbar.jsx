    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-[#f0f0f0] shadow-md">
      <div className="max-w-[1440px] mx-auto flex justify-between items-center px-4 md:px-6 py-4 md:py-6">
        ...
        <div className="flex items-center gap-1.5 md:gap-4 font-sohne shrink-0">
          ...
          <button className="hidden md:block bg-[#00A5A9] text-white px-5 py-3 rounded-[6px] text-[14px] font-semibold uppercase tracking-wider transition-all hover:bg-[#008c8f] whitespace-nowrap">
            BOOK APPOINTMENT
          </button>

          <div className="flex items-center gap-1 md:gap-1.5">
            {/* Phone Icon Box - Always Visible (Mobile and Desktop) */}
            <div className="bg-[#4980AA] text-white p-2.5 md:p-3.5 rounded-[4px] md:rounded-[6px] flex items-center justify-center transition-all hover:bg-[#3d6b8f] cursor-pointer">
              <FaPhoneAlt className="text-[12px] md:text-base" />
            </div>

            {/* Phone Number Box - Only shown on Desktop (md onwards) */}
            <div className="hidden md:flex bg-[#4980AA] text-white px-5 py-3 rounded-[6px] items-center text-[16px] font-medium transition-all hover:bg-[#3d6b8f] whitespace-nowrap">
              +91-9784524567
            </div>
          </div>
        </div>
